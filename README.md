...
更长远的方向是：让每个人先通过充分的自我探索、可信 AI 对话或专业陪伴，理解自己真正需要练习的主题，再基于这个开源核心生成一套只保存在本地的个性化练习 App。公开仓库只提供通用框架和安全边界，不包含任何个人隐私故事。
...
详见 [docs/PERSONALIZATION.md](docs/PERSONALIZATION.md)。简要来说，个性化应发生在用户自己的本地副本或私有仓库中，而不是发生在公共仓库中。公共仓库永远不应收集、展示或推断具体用户的私人创伤经历。
